...
#     если число, предположенное игроком, не совпадает с загаданным
...
print("\a\nBaм удалось отгадать число! Это в самом деле", the_number, end=".\n")
print("Bы затратили на отгадывание всего лишь", tries, "попыток!")
input("\nНажмите Enter, чтобы выйти.")

# end=".\n" убирает пробел между значением the_number и точкой
# Вам удалось отгадать число! Это в самом деле 50.
